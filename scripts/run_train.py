...
KEY_MAP = {
    ...
    ("agent", "log_std_max"): "log_std_max",
    ("train", "target_clip"): "target_clip",
    ("train", "target_clip_rel"): "target_clip_rel",
    ("train", "natural_target"): "natural_target",
    ("train", "likelihood_energy"): "likelihood_energy",
    ("train", "likelihood_adv_mode"): "likelihood_adv_mode",
    ("train", "likelihood_tau"): "likelihood_tau",
    ("train", "policy_geometry"): "policy_geometry",
    ("train", "precision_beta"): "precision_beta",
    ("train", "precision_max_radius"): "precision_max_radius",
    ("train", "parameter_pc_damping"): "parameter_pc_damping",
    ("train", "parameter_pc_step_size"): "parameter_pc_step_size",
    ("train", "parameter_pc_max_radius"): "parameter_pc_max_radius",
    ("train", "parameter_pc_max_kl"): "parameter_pc_max_kl",
    ("train", "parameter_pc_cg_iters"): "parameter_pc_cg_iters",
    ("train", "parameter_pc_cg_tol"): "parameter_pc_cg_tol",
    ("train", "parameter_pc_joint_steps"): "parameter_pc_joint_steps",
    ("train", "parameter_pc_joint_parameter_rate"): "parameter_pc_joint_parameter_rate",
    ("train", "parameter_pc_joint_activity_rate"): "parameter_pc_joint_activity_rate",
    ("train", "parameter_pc_joint_error_rate"): "parameter_pc_joint_error_rate",
    ("train", "parameter_pc_joint_penalty"): "parameter_pc_joint_penalty",
    ("train", "parameter_pc_joint_precision_rate"): "parameter_pc_joint_precision_rate",
    ("train", "parameter_pc_joint_precision_min"): "parameter_pc_joint_precision_min",
    ("train", "parameter_pc_joint_precision_max"): "parameter_pc_joint_precision_max",
    ("train", "parameter_pc_exact_kl_steps"): "parameter_pc_exact_kl_steps",
    ("train", "parameter_pc_exact_kl_primal_rate"): "parameter_pc_exact_kl_primal_rate",
    ("train", "parameter_pc_exact_kl_dual_rate"): "parameter_pc_exact_kl_dual_rate",
    ("train", "parameter_pc_exact_kl_penalty"): "parameter_pc_exact_kl_penalty",
    ("train", "parameter_pc_exact_kl_tol"): "parameter_pc_exact_kl_tol",
